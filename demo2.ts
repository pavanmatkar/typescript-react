...
console.log(fun_one(),fun_two(),fun_three() );      //ReactJS NodeJS MongoDB
*/
/*
...
console.log(obj);       //{ var_one: 'Hello_1', var_two: 'Hello_2', var_three: 'Hello_3' }
*/
/*
...
console.log( obj.var_one,obj.getVarOne() );         //Hello_1 Hello_1

let obj1:class_one = new class_one();
console.log(obj1.var_one,obj1.getVarOne());         //Hello_2 Hello_2
