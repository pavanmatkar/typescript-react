...
console.log(add("Hello_1","Hello_2"));      //Hello_1 Hello_2
console.log(add(10,"Hello"));       //10 Hello
*/
/*
class class_one{
...
*/
//static 
//static membes we can access by using "class names" directly
...
/*
//readonly
//readonly modifier allows us to readonly data, but we can't update it 
